    ...
    <div className="container">
      <div className="header">
        <div className="full-name">
          <span className="first-name">{profile.firstName}</span> 
          <span className="last-name">{profile.secondName}</span>
        </div>
        <div className="contact-info">
          <span className="email">Email: </span>
          <span className="email-val">{profile.email}</span>
          <span className="separator"></span>
          <span className="phone">Country: </span>
          <span className="phone-val">{profile.country}</span>
        </div>
       ...
       <div className="details">
        <div className="section">
          <div className="section__title">Experience({profile.yearsOfExp} years)</div>
